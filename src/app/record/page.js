            ...
            <div className="space-y-4">
              ...
              <div className="record-box">
                  ...
                  <>
                    <section className="grid grid-cols-12">
                      <div className="mb-3 col-span-8">
                        ...
                        <div className="recordCheckbox-2">
                          <input
                            type="checkbox"
                            defaultChecked={finalAdjust[0] != 0}
                            readOnly
                          />
                          <label>
                            {lang == "th"
                              ? "ความผิดปกติของคลื่นไฟฟ้าหัวใจขณะพัก (การเปลี่ยนแปลงของคลื่น Q หรือการเปลี่ยนแปลงของส่วน ST/คลื่น T)"
                        ...
                        <div className="recordCheckbox-2">
                          <input
                            type="checkbox"
                            defaultChecked={finalAdjust[1] != 0}
                            readOnly
                          />
                          <label>
                            {lang == "th"
                              ? "ผลการตรวจคลื่นไฟฟ้าหัวใจขณะออกกำลังกายที่ผิดปกติ"
                        ...
                        <div className="recordCheckbox-2">
                          <input
                            type="checkbox"
                            defaultChecked={finalAdjust[2] != 0}
                            readOnly
                          />
                          <label>
                            {lang == "th"
                              ? "ภาวะการทำงานบกพร่องของหัวใจห้องล่างซ้าย (ชนิดรุนแรงหรือเฉพาะส่วน)"
                        ...
                        <div className="recordCheckbox-2">
                          <input
                            type="checkbox"
                            defaultChecked={finalAdjust[3] != 0}
                            readOnly
                          />
                          <label>
                            {lang == "th"
                        ...
                        <div className="recordCheckbox-2">
                          <input
                            type="checkbox"
                            defaultChecked={finalAdjust[4] != 0}
                            readOnly
                          />
                          <label>
                            {lang == "th"
                        ...
                        <div className="recordCheckbox-2">
                          <input
                            type="checkbox"
                            defaultChecked={finalAdjust[5] != 0}
                            readOnly
                          />
                          <label>
                            {lang == "th"
                              ? "การสะสมของแคลเซียมในหลอดเลือดหัวใจที่พบจากภาพถ่ายทรวงอกที่มีอยู่เดิม"
                ...
                <div className="mt-3">
                  <span className="mb-7 border border-secondary shadow-md font-semibold text-[0.7rem] lg:text-lg flex items-center justify-center py-1.5 px-5 rounded-3xl bg-primary text-white">
                    {lang == "th"
                      ? "ความน่าจะเป็นทางคลินิกที่ถ่วงน้ำหนักด้วย CACS"
                ...
                <div className="relative">
                  <img
                    ...
                    src={
                      lang == "th" ? "/img/graph2-th.png" : "/img/graph2.png"
                    }
                    width={939}
                    height={355}
                          ...
                          <p
                            className={
                              CACS < 7
                                ...
                                ? "result-circle-text text-[#fbef20]"
                                : CACS >= 50 && CACS < 85
                                ? "result-circle-text text-[#fbae3d]"
                                : CACS >= 85
                                ? "result-circle-text text-[#f2654c]"
                                : ""
                            }
                          >
                            {getRiskLevel(CACS)}
                                ...
                                <span
                                  className={
                                    CACS < 7
                                      ...
                                      ? "inline-flex aspect-square items-center justify-center text-[1.2rem] lg:text-3xl bg-[#fbef20] text-white size-14 lg:size-24 rounded-full"
                                      : CACS >= 50 && CACS < 85
                                      ? "inline-flex aspect-square items-center justify-center text-[1.2rem] lg:text-3xl bg-[#fbae3d] text-white size-14 lg:size-24 rounded-full"
                                      : CACS >= 85
                                      ? "inline-flex aspect-square items-center justify-center text-[1.2rem] lg:text-3xl bg-[#f2654c] text-white size-14 lg:size-24 rounded-full"
                                      : ""
                                  }
                                >
                                  {
