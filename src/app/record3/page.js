      ...
      <>
        <div className="max-w-[500px] mx-auto bg-white shadow min-h-screen overflow-hidden app-wrapper relative">
          <main
            ref={pdfRef}
            id="record"
            className="my-0 p-2 py-0 bg-white mx-auto max-w-screen-md relative"
          >
                  ...
                  <div className="space-y-1 mt-4 ">
                    ...
                    <div className="recordCheckbox">
                      <input
                        ...
                        readOnly
                      />
                      <label>{lang == "th" ? "โรคเบาหวาน" : "Diabetes"}</label>
                    </div>
                    <div className="recordCheckbox">
                      <input
                        type="checkbox"
                        ...
                        readOnly
                      />
                      <label>{lang == "th" ? "ไม่มี" : "None of Above"}</label>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="hidden" id="renderForImage">
                <div className="p-5 bg-primary text-white rounded-xl">
                  ...
                  <p
                    className={
                      RF_PTP < 7
                        ? "text-3xl font-bold text-center text-[#74b8e4]"
                        : RF_PTP >= 7 && RF_PTP < 17
                        ? "text-3xl font-bold text-center text-[#45bc8d]"
                        : RF_PTP >= 17
                        ? "text-3xl font-bold text-center text-[#c7c246]"
                        : ""
                    }
                  >
                    {getRiskLevel(RF_PTP)}
                    ...
                    <div className="flex-initial">
                      <div className="text-center">
                        <span
                          className={
                            RF_PTP < 7
                              ? "inline-flex aspect-square items-center justify-center text-3xl bg-[#74b8e4] text-white w-24 h-24 rounded-full"
                              : RF_PTP >= 7 && RF_PTP < 17
                              ? "inline-flex aspect-square items-center justify-center text-3xl bg-[#45bc8d] text-white w-24 h-24 rounded-full"
                              : RF_PTP >= 17
                              ? "inline-flex aspect-square items-center justify-center text-3xl bg-[#c7c246] text-white w-24 h-24 rounded-full"
                              : ""
                          }
                        >
                ...
                <div className="record-box">
                  <h2 className="text-lg font-bold text-primary mb-4">
                    {lang == "th"
                      ? "Consider reclassification of low RF-CL"
                      : "Consider reclassification of low RF-CL"}
                  </h2>
                  <img
                    src="/img/graph2.png"
                  ...
                  <div className="mt-4">
                    <p>
                      <span className="font-semibold inline-block w-[80px]">
                        CACS CL
                      </span>{" "}
                      <span className="">:</span>{" "}
                      <span className="ml-4">{CACS} %</span>
                    </p>
                    <p>
                      <span className="font-semibold inline-block w-[80px]">
                        RF_PTP
                      ...
                      <span className="">:</span>{" "}
                      <span className="ml-4">{RF_PTP} %</span>
                    </p>
                  </div>
                </div>
              </div>
