            ...
            <main id='record' className="my-0 p-2 py-0 bg-white mx-auto max-w-screen-md relative app-wrapper">
                ...
                <div className='space-y-4'>
                    ...
                    <div className="p-2 lg:p-5 py-4 lg:py-10 bg-primary text-white rounded-xl">
                        <div className="flex flex-row gap-5 items-center justify-center">
                            <div>
                                ...
                                <p className={RF_PTP < 7 ? "result-circle-text text-[#74b8e4]" : RF_PTP >= 7 && RF_PTP < 17 ? "result-circle-text text-[#45bc8d]" : RF_PTP >= 17 ? "result-circle-text text-[#fbef20]" : "" }>{getRiskLevel(RF_PTP)}</p>
                            </div>
                            <div>
                                <div className="flex flex-row gap-5 items-center justify-center">
                                    <div>
                    ...
                    <div id='hiddenForImage' className='text-center mt-10 grid grid-cols-2 gap-3 px-3'>
                        ...
                        <button className="btn btn-primary w-full" onClick={() => router.push('/print-section1')}>
                            {
